...
class SampleNativeComponentEventEmitter : public ViewEventEmitter {
 public:
  ...
  enum class OnIntArrayChangedYesNos { Yep, Nope };

  static const char* toString(const OnIntArrayChangedYesNos value) {
    switch (value) {
      case OnIntArrayChangedYesNos::Yep:
        return "yep";
      case OnIntArrayChangedYesNos::Nope:
        return "nope";
    }
  }
