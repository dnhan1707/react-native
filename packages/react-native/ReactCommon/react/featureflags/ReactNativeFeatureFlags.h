...
class ReactNativeFeatureFlags {
 public:
  ...
  /**
   * Adds support for recursively processing commits that mount synchronously
   * (Android only).
   */
  ...
  /**
   * Forces the mounting layer on Android to always batch mount items instead of
   * dispatching them immediately. This might fix some crashes related to
   * synchronous state updates, where some views dispatch state updates during
   * mount.
   */
